...
export const productionEnvironment: Environment = {
  ...
  apiUrl:
    ...
    "https://oypunu-production.up.railway.app/v1",
  websocketUrl:
    process.env.EXPO_PUBLIC_WEBSOCKET_URL ||
    "https://oypunu-production.up.railway.app",
...
export const developmentEnvironment: Environment = {
  ...
  apiUrl:
    process.env.EXPO_PUBLIC_API_URL ||
    "https://oypunu-production.up.railway.app/api",
  websocketUrl:
    process.env.EXPO_PUBLIC_WEBSOCKET_URL ||
    "https://oypunu-production.up.railway.app",
  enableLogging:
    process.env.EXPO_PUBLIC_ENABLE_LOGGING === "false" ? false : true,
