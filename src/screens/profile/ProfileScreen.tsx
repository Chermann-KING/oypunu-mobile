...
export const ProfileScreen: React.FC = () => {
  ...
  useEffect(() => {
    if (isAuthenticated && user && user.id) {
      ...
      if (user.role !== "user") {
        loadContributionStats().catch((error) =>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <Card variant="elevated" padding={6}>
          ...
          <View style={styles.statsContainer}>
            <StatItem
              ...
              label="Mots ajoutés"
              value={userStats?.totalWordsAdded ?? 0}
            ...
            <StatItem
              ...
              label="Favoris"
              value={
                userStats?.favoriteWordsCount ??
                favoritesStats?.totalFavorites ??
                0
              }
              loading={isLoadingUserStats || isLoadingStats}
            />
            <StatItem
              ...
              value={
                ...
                userStats?.totalCommunityPosts ??
                0
              }
              loading={isLoadingContributionStats || isLoadingUserStats}
            />
          </View>
        </Card>
        ...
        <View style={styles.section}>
          ...
          <Card
            variant="default"
            padding={4}
            onPress={() => console.log("Mes contributions")}
          >
            <View style={styles.menuItem}>
